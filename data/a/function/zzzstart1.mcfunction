...
execute store result score @e[type=armor_stand,tag=score] rdm run random value 1..20
...
tellraw @a {"text":"Your goal is to complete 45 of the death messages (that you can see if you run /trigger reminder)! Good luck and have fun!","color":"gold"}